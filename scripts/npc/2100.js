...
if (mapId === 0 || mapId === 3) {
    ...
    npc.sendNext("This is the image room where your first training program begins. In this room, you will have an advance look into the job of your choice.");
    npc.sendNext("Once you train hard enough, you will be entitled to occupy a job. You can become a Bowman in Henesys, a Magician in Ellinia, a Warrior in Perion, a Thief in Kerning City, and a Pirate in Nautilus Port.");
}
