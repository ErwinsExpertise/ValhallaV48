// Arwen the Fairy / fairy alchemist

if (plr.job() === 0 || plr.getLevel() <= 39) {
    npc.sendOk("I can make rare and valuable items, but unfortunately I can't make them for a stranger like you.");
} else {
    npc.sendBackNext(
