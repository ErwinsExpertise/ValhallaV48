ALTER TABLE `items`
    ADD COLUMN `ringID` INT(11) DEFAULT NULL AFTER `cashSN`;
...
ALTER TABLE `account_storage_items`
    ADD COLUMN `ringID` INT(11) DEFAULT NULL AFTER `creatorName`;

ALTER TABLE `account_cashshop_storage_items`
    ADD COLUMN `ringID` INT(11) DEFAULT NULL AFTER `sn`;
