...
func init() {
	...
	Mob.HealAoe = 114
	// Missing in v48 NX: Mob.speedUpAoe = 115
	Mob.Seal = 120
	Mob.Darkness = 121
	Mob.Weakness = 122
	Mob.Stun = 123
	...
	Mob.Dispel = 127
	Mob.Seduce = 128
	// Missing in v48 NX: Mob.SendToTown = 129
	Mob.PoisonMist = 131
	// Missing in v48 NX: Mob.CrazySkull = 132
	// Missing in v48 NX: Mob.Zombify = 133
	Mob.WeaponImmunity = 140
	Mob.MagicImmunity = 141
	// Missing in v48 NX: Mob.ArmorSkill = 142
	// Missing in v48 NX: Mob.WeaponDamageReflect = 143
	// Missing in v48 NX: Mob.MagicDamageReflect = 144
	// Missing in v48 NX: Mob.AnyDamageReflect = 145
	// Missing in v48 NX: Mob.McWeaponAttackUp = 150
	// Missing in v48 NX: Mob.McMagicAttackUp = 151
	// Missing in v48 NX: Mob.McWeaponDefenseUp = 152
	// Missing in v48 NX: Mob.McMagicDefenseUp = 153
	// Missing in v48 NX: Mob.McAccuracyUp = 154
	// Missing in v48 NX: Mob.McAvoidUp = 155
	// Missing in v48 NX: Mob.McSpeedUp = 156
	// Missing in v48 NX: Mob.McSeal = 157 // Not actually used in Monster Carnival
	Mob.Summon = 200
